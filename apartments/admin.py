...
class ApartmentAdmin(admin.ModelAdmin):
    ...
    fields = ('title', 'description', 'country', 'city', 'address', 'latitude', 'longitude', 'beds', 'apartment_age', 'rating', 'monthly_cost', 'original_owner', 'vote_sum', 'vote_amount', 'size', 'owner', 'contracts')
